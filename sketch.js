...
var tree, stone,ground,backgroundImagemage;
...
function preload(){
  ...
  backgroundImage = loadImage("images/bgImg.jpeg" );
}

function setup() {
	createCanvas(1260,638);
  ...
  mango2 = new Mango(1170,130,30);
	...
	tree = new Tree(1050,530);
	ground = new Ground(0,1000,width,20);
